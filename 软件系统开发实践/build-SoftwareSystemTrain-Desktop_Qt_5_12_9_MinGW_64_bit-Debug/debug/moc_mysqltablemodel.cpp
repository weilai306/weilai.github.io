/****************************************************************************
** Meta object code from reading C++ file 'mysqltablemodel.h'
**
...
#include "../../SoftwareSystemTrain/mysqltablemodel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'mysqltablemodel.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject MySqlTableModel::staticMetaObject = { {
    &QSqlTableModel::staticMetaObject,
    qt_meta_stringdata_MySqlTableModel.data,
    qt_meta_data_MySqlTableModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
