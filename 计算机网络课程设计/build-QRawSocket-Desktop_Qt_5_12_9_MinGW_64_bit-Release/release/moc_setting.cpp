...
QT_MOC_LITERAL(6, 24, 1), // "d"
QT_MOC_LITERAL(7, 26, 22), // "on_buttonClear_clicked"
QT_MOC_LITERAL(8, 49, 24) // "on_buttonConfirm_clicked"

    },
    "Setting\0mysignal\0\0a\0b\0c\0d\0"
    "on_buttonClear_clicked\0on_buttonConfirm_clicked"
};
...
static const uint qt_meta_data_Setting[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Bool, QMetaType::Bool, QMetaType::QString, QMetaType::QString,    3,    4,    5,    6,
...
void Setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mysignal((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4]))); break;
        ...
        {
            using _t = void (Setting::*)(bool , bool , QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Setting::mysignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Setting::mysignal(bool _t1, bool _t2, QString _t3, QString _t4)
{
